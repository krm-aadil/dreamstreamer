...
const EditAlbums = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">Edit Albums</h2>

      {/* Edit Form */}
      {editingAlbum && (
        <div className="mb-6 p-4 bg-gray-800 text-white rounded">
          <h3 className="text-lg font-semibold mb-2">Editing {editingAlbum.albumName}</h3>
          <input
            type="text"
            name="albumName"
          ...
          {/* Album Art Input */}
          <label className="block mb-2">Change Album Art (Image)</label>
          <input
            type="file"
            name="albumArt"
            accept="image/*"
          ...
          {/* Tracks Input */}
          <label className="block mb-2">Replace or Add New Tracks (MP3)</label>
          <input
            type="file"
            name="tracks"
            accept="audio/*"
